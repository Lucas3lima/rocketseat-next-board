...
function CardRoot({ className, ...props }: CardRootProps) {
  return (
    <Link
      className={twMerge(
        'bg-navy-700 border-[0.5px] border-navy-600 rounded-lg p-3 space-y-4 block',
        'hover:bg-navy-600/50 hover:border-navy-500 transition-colors duration-150',
        'autoline-none focus-visible:ring-2 focus-visible:ring-navy-400 focus-visible:ring-offset-2 focus-visible:ring-offset-navy-950',
        className,
      )}
      {...props}
    />
